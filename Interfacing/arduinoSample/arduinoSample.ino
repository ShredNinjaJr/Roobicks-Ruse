/*
    This code pairs with the serialOutSample.cpp to receive input
    and change the LED state accordingly. We can receive commands
    in this way to perform corresponding claw functions.
    --Austin Powers 2014
*/
int ledPin = 13;
int state=0;
